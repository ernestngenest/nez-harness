...
Generated endpoint reference for the `manage-agent-state` rows of the `deepapi` skill router. Bundle version: b4f140d187ae. This file is always managed — it is refreshed with the bundle even when `../SKILL.md` has been customized.
